...
export class OrderProductController {
  ...
  @Post()
  public async postOrderProduct(
    @Body() new_order_product: OrderProductCreateDTO,
  ) {
    ...
    if (order == null) throw new NotFoundException('No existe esa orden');
    if (product == null) throw new NotFoundException('No existe ese producto');
  }
}
